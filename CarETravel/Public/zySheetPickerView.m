...
-(void)setupUI
{
    ...
    //选择器
    UIPickerView *pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(5,22, SCREEN_SIZE.width-10, 160)];
...
//    [self setFrame: CGRectMake(0, SCREEN_SIZE.height,SCREEN_SIZE.width , 250)];
    [self setFrame: CGRectMake(0, SCREEN_SIZE.height,SCREEN_SIZE.width , 200)];
}
...
//        self.frame = CGRectMake(0, SCREEN_SIZE.height-250, SCREEN_SIZE.width, 250);
        self.frame = CGRectMake(0, SCREEN_SIZE.height-200, SCREEN_SIZE.width, 200);
    } completion:NULL];
}
...
//        self.frame = CGRectMake(0, SCREEN_SIZE.height,SCREEN_SIZE.width , 250);
        self.frame = CGRectMake(0, SCREEN_SIZE.height,SCREEN_SIZE.width , 200);
